...
import com.techzone.item.Accessory;
 ...
 * @author User
 */
public class AddAccessory extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ADD NEW ACCESSORIES");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int rowCount = dBConnection.getItemCount("SELECT COUNT(*) FROM accessory");
        int id = rowCount + 1;
        String query = "INSERT INTO accessory (itemnumber,model,brand,itemtype,description,price,quantity,warranty) "
                + "VALUES ('A"+ id + "','" + jTextField1.getText() + "', '" + jTextField2.getText() + "', '" + jTextField4.getText() + "', '" 
                + jTextField11.getText() + "', " + jTextField5.getText() + ", " + jTextField7.getText() + ", " + jTextField6.getText() + ")" ;
        boolean success = dBConnection.saveItem(query);
        if(success) {
            jLabel3.setText("Item added successfully");
        }else{
            jLabel3.setText("Unable to add item");
        } 
